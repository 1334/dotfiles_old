...
hi Directory    guifg=#1600FF ctermfg=21
hi ErrorMsg     guibg=Firebrick2 guifg=White
hi FoldColumn   guibg=Grey guifg=DarkBlue
hi Folded       guibg=#E6E6E6 ctermbg=7 guifg=DarkBlue
...
if has("gui_macvim")
  ...
  hi Visual       guibg=#72F7FF ctermbg=87
endif
...
if &background == "dark"
  ...
  hi LineNr       guifg=#552A7B ctermfg=54 guibg=Grey5
...
if has("gui_macvim") && !exists("s:augroups_defined")
  au FocusLost * if exists("colors_name") && colors_name == "macvim-term" | hi Visual guibg=MacSecondarySelectedControlColor | endif
  au FocusGained * if exists("colors_name") && colors_name == "macvim-term" | hi Visual guibg=MacSelectedTextBackgroundColor | endif
